        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item">
                        <a class="text-secondary" href="{{ route('invoices.index') }}">INVOICE</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">TRANSACTIONAL INVOICES ({{ $transactions->count() }})</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
