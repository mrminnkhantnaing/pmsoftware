...
@section('title')
    Lost Cards | {{ config('app.name', 'PM Software') }}
@endsection
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">LOST DOOR CARDS ({{ $lostCardsCount }})</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="example" class="table align-middle table-hover table-striped table-bordered" style="width:100%">
                                    ...
                                    <tbody>
                                        @foreach ($lostCards as $index => $card)
