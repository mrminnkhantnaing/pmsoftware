...
@section('title')
    All Cards | {{ config('app.name', 'PM Software') }}
@endsection
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">DOOR CARDS ({{ $cards->count() }})</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                            ...
                            <div class="pt-3">
                                <p title="Total Cards">
                                    <strong class="text-dark">
                                        <a class="text-decoration-none text-dark" href="{{ route('cards.index') }}">Total Card{{ $cards->count() <= 1 ? '' : 's' }}:</a>
                                    </strong>
                                    {{ $cards->count() }}
                                </p>
