...
@section('title')
    Add New Floor | {{ config('app.name', 'PM Software') }}
@endsection
                        ...
                        <form action="{{ route('floors.store') }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10 text-secondary">
                                    <input type="text" class="form-control @error('name') border border-danger @enderror" name="name" value="{{ old('name') }}" placeholder="Eg. 1st Floor" />
                                    @error('name')
